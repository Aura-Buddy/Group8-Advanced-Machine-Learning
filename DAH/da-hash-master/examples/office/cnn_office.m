...
preModelPath = 'C:/Users/ncson/OneDrive/Desktop/da-hash-master/da-hash-master/data/imagenet-vgg-f.mat';
% Experimental results are stored at exp_root
exp_root = ['C:/Users/ncson/OneDrive/Desktop/da-hash-master/da-hash-master/data/', home];
% Train data path (data is stored at data_root)
data_root = ['C:/Users/ncson/OneDrive/Desktop/da-hash-master/da-hash-master/data/OfficeHome/', home];
...
if numel(meta.normalization.imageSize) == 3
  mu = double(meta.normalization.imageSize(:)) ;
else
  mu = imresize(single(meta.normalization.imageSize), ...
                meta.normalization.imageSize(1:2)) ;
end
