...
srcNetFile = '/mnist-baseline-dagnn/digit_da/net-epoch-1';
...
dataRoot = 'C:/Users/ncson/OneDrive/Desktop/da-hash-master/da-hash-master/data';
imDataRoot = 'C:/Users/ncson/OneDrive/Desktop/da-hash-master/da-hash-master/data/OfficeHome/OfficeHome/';
...
netDir = fullfile(netRoot, 'mnist-baseline-dagnn');
netFile = findLastNetFile(netDir);
netPath = fullfile(netDir, netFile);

imdbPath = [dataRoot, '/DB/digit_da/mnist_usps-vgg-daSfx/', imdbFile];

opts.saveFilePath = [dataRoot,'fortSNE.mat'];
